  ...
  <div class="w3-col s4">
    ...
    <p>If you are </p>
      <form id="login" name="login" form action="checkauth.php" method="post" style="width:80%">
        <p><input class="w3-input w3-border" type="text" placeholder="Last Name" name="LName" required></p>
        <p><input class="w3-input w3-border" type="password" placeholder="Last 4 SSN" name="SSN" pattern=".{4,4}" required title="4 characters"></p>
        <p><input class="w3-input w3-border" type="text" placeholder="signupusername" name="Username" required></p>
